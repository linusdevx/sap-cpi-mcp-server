...
export function register(server: McpServer): void {
  ...
  server.registerTool(
    ...
    {
      title: 'Get variables',
      description: 'List runtime variables (state maintained between iFlow executions)',
  ...
  server.registerTool(
    'get_number_ranges',
    {
      ...
      description: 'List number ranges (auto-incrementing sequences for message numbering)',
      inputSchema: queryShape,
      annotations: { readOnlyHint: true },
    },
    async ({ filter, top, orderby, select, skip }) => {
